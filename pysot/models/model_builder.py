...
from pysot.models.utile.utile import hiftmodule,Adadownsamplingnet_tem
import numpy as np
...
class ModelBuilder(nn.Module):
    ...
    def forward(self,data):
        ...
        pd_loss=cfg.TRAIN.w6*Downsamplingloss(zf,zff)
                +cfg.TRAIN.w7*Downsamplingloss(xf,xff)
        ...
        outputs['total_loss'] =\
            cfg.TRAIN.LOC_WEIGHT*loc_loss\
                +cfg.TRAIN.CLS_WEIGHT*cls_loss+cfg.TRAIN.PD_WEIGHT*pd_loss
        outputs['cls_loss'] = cls_loss
        outputs['loc_loss'] = loc_loss
        outputs['pd_loss'] = pd_loss
